...
def test_fetch_radioeins_albums(requests_mock):
    ...
    """
    requests_mock.get("https://www.radioeins.de/musik/top_100/die-100-besten-2019/alben/alben---die-top-100.html", text=mock_html)
...
def test_fetch_books_from_site(requests_mock):
    ...
    """
    requests_mock.get("https://www.die-besten-aller-zeiten.de/buecher/kanon/new-york-times-21-jahrhundert.html", text=mock_html)
