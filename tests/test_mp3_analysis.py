...
from data_sources.mp3_analysis import (
    analyze_mp3_archive,
...
def test_search_artist_albums_in_library(mocker):
    ...
    mock_instance.search.return_value = [{"title": "OK Computer", "zentralbibliothek_info": "Verfügbar"}]
...
def test_find_new_albums_for_top_artists(mocker):
    ...
    mocker.patch(
        "data_sources.mp3_analysis.search_artist_albums_in_library",
        return_value=[{"title": "OK Computer", "author": "Radiohead"}, {"title": "Kid A", "author": "Radiohead"}],
    )
