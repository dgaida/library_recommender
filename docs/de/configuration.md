...
- `data_sources/mp3_analysis.py`: Ändern Sie den Pfad in `add_top_artist_albums_to_collection("PFAD/ZU/DEINEM/MP3/ARCHIV", top_n=10)`.
...
Die App schlägt standardmäßig 12 Titel pro Kategorie vor (4 pro Datenquelle). Dies kann in `recommender/recommender.py` angepasst werden.
