# 🎬📀📚 Library Recommender App

Welcome to the **Library Recommender App** documentation!

This is an intelligent recommendation system for the **Cologne City Library (Stadtbibliothek Köln)**. It suggests available films, albums, and books based on curated lists of high-quality media.
